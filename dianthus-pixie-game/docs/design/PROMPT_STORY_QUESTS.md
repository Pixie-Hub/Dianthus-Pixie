> **Historical spec.** The implemented chain is `story_05_devourer_omens` → `story_06_pollen` → `story_07_devourer`. Core Sanctum is no longer a zone — see GDD §10.1 and STORY_OUTLINE §3.
