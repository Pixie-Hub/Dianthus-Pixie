...
| VFX-01 | Player Animations | Audio/Visual | High | In Progress | FOUND-03 | [Unassigned] | L | • Attack, roll/dodge, and respawn animations per GDD §12.2; • states linked to player state machine; • respawn plays brief invincibility glow |
