...
| DAY-04 | Scout Tracks Night Intel | Core Mechanics | High | Done | DAY-01, CORE-07, UI-01 | [Unassigned] | M | • Optional daytime Scout Tracks interaction reveals one likely active night spawn direction; • the reveal appears on HUD, minimap, or preparation UI; • interaction costs enough daytime to compete with gathering |
