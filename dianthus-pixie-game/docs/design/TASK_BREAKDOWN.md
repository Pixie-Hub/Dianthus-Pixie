...
| WORLD-02 | Ruins of Veld Zone | World & Map | High | Done | WORLD-01 | [Unassigned] | L | • Ruined-city biome tilemap; Shadow Resin and Kunyit nodes per GDD §10.1; • unlocks Day 7 via story quest gate (`unlock_zone_ruins`); zone contains a story-relevant landmark; • Ruins has no Dianthus Core and no night defense — the final fight returns to Meadow Edge |
| WORLD-03 | Dusk Forest Blackwater Hollow Sub-Area | World & Map | Medium | Done | WORLD-01, QUEST-05 | [Unassigned] | L | • Hidden sub-area within Dusk Forest; story-gated: unlocks after Story 04 complete (~Day 8–9), no hard day-gate; • Aether Bloom pickup nodes, optional ambient-slow tile type (inherits "darkness can shelter life" theme); • Note: scope previously listed as WORLD-03 Obsidian Bog is now absorbed here |
...
| QUEST-05 | Story Quests | Quest System | High | Done | QUEST-01, WORLD-02 | [Unassigned] | L | • Full chain per GDD §16: Ruins investigation → Devourer omen → Devourer; • critical quests carry time limits; • failure triggers alternative ending, not immediate game over per GDD §5.1 |
...
| VFX-04 | Plant Animations | Audio/Visual | Medium | In Progress | PLANT-05 | [Unassigned] | M | • Shared PlantAnimationController and PlantBase hooks added; • Bougainvillea and Melati prototype scenes wired for bloom, active, and wither; • TODO: VFX-04 add scene-authored animation nodes/resources for the remaining 9 plant entities; • TODO: VFX-04 replace prototype static-frame SpriteFrames with authored 64x64 bloom/active/wither sheets for all 11 plants; • wither triggers through PlantBase destroy path |
