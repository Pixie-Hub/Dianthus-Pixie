...
| WORLD-01 | Dusk Forest Zone | World & Map | High | Done | CORE-01 | [Unassigned] | L | • Dim-light biome tilemap with desaturated palette; Moonspore, Wijaya Kusuma, Rafflesia nodes placed per GDD §10.1; • unlocks Day 3; scene transition from Meadow Edge |
| WORLD-02 | Ruins of Veld Zone | World & Map | High | Done | WORLD-01 | [Unassigned] | L | • Ruined-city biome tilemap; Shadow Resin and Kunyit nodes per GDD §10.1; • unlocks Day 7 via story quest gate; zone contains a story-relevant landmark |
