...
| DAY-02 | Bramble Obstacles & Optional Pockets | World & Map | High | Done | DAY-01, CORE-05 | [Unassigned] | M | • Bramble obstacles block optional shortcuts or reward pockets, not mandatory paths; • brambles can be cleared with existing attack/collision/HP patterns; • cleared pockets reward uncommon resources or faster return routes |
| DAY-03 | Rare Harvest Node & QTE Hook | Minigames | High | Done | DAY-01, CORE-02, MINI-03 | [Unassigned] | M | • At least one rare resource node triggers the Harvest QTE; • success grants full or bonus yield; • failure grants 50% yield and communicates the reduced reward clearly |
...
| DAY-11 | Fortification System | Core Mechanics | Medium | Done | CORE-02, DAY-08 | [Unassigned] | M | • 4 fixed FortificationSpots at garden N/S/E/W perimeter; • Thorn Barricade (60 HP wall, cost 3 Petal Shard + 2 Verdant Sap, 4 s build time, unlocks Day 3) or Spore Trap (15 DMG + 3 s 0.5× slow, cost 2 Verdant Sap + 1 Moonspore, 3 s build time, unlocks Day 5) per spot; • locked defense types show `Requires Day X` in the InteractionPrompt; • hold E builds, tap E switches type; • can't build during NIGHT; • all structures despawn at dawn (phase→DAY); • `Shift+4` debug key adds full fortification materials |
...
| ENEMY-04 | Swarm Larva Enemy FSM | Enemy AI | High | Done | CORE-06 | [Unassigned] | L | • 15 HP/unit, 3 DMG, spawns 5–10 per GDD §8.1; • independent FSM per unit with flocking cohesion in Swarm (custom Scout) state; • weak to AoE weapons; unlocks Day 8; batch spawning in WaveSpawner |
| ENEMY-05 | The Devourer Boss (3 Phases + Minion Summon) | Enemy AI | High | Done | ENEMY-01, ENEMY-02, ENEMY-03, ENEMY-04 | [Unassigned] | XL | • 1200 HP, 50 DMG/hit per GDD §8.1; • 3 mechanically distinct phases with minion summoning; • weak to Dianthus Pollen weapon (is_pollen_weapon flag on WeaponData); triggers on final story night via story_07_devourer quest; boss HP bar in HUD; phase-synced music seek; Ctrl+5/6/7 debug keys; placeholder SFX nodes registered |
| WORLD-01 | Dusk Forest Zone | World & Map | High | Done | CORE-01 | [Unassigned] | L | • Dim-light biome tilemap with desaturated palette; Moonspore, Wijaya Kusuma, Rafflesia nodes placed per GDD §10.1; • unlocks Day 3 (story_02 complete, `unlock_zone_dusk_forest`); scene transition from Meadow Edge; • includes Blackwater Hollow entrance (see WORLD-03 for sub-area content) |
| WORLD-02 | Ruins of Veld Zone | World & Map | High | Done | WORLD-01 | [Unassigned] | L | • Ruined-city biome tilemap; Shadow Resin and Kunyit nodes per GDD §10.1; • unlocks Day 7 after the Dusk Forest/Blackwater story resolution grants `unlock_zone_ruins`; zone contains a story-relevant landmark; • Ruins has no Dianthus Core and no night defense — the final fight returns to Meadow Edge |
| WORLD-03 | Dusk Forest Blackwater Hollow Sub-Area | World & Map | Medium | Done | WORLD-01, QUEST-05 | [Unassigned] | L | • Hidden sub-area within Dusk Forest; story-gated: unlocks after Story 03 complete so Story 04 can resolve Blackwater Hollow, no hard day-gate; • Aether Bloom pickup nodes, optional ambient-slow tile type (inherits "darkness can shelter life" theme); • Note: scope previously listed as WORLD-03 Obsidian Bog is now absorbed here |
| WORLD-04 | Core Sacred Bloom Interactable (Meadow Edge) | World & Map | Medium | Done | CORE-03, QUEST-05 | [Unassigned] | M | • After Story 05 completes (`unlock_core_sacred_bloom`), the Dianthus Core in Meadow Edge enters Sacred Bloom state; • player can interact with the Core to harvest Dianthus Pollen (1×/day cooldown, cooldown resets at dawn); • visual: Core pulses with white-pink pollen motes while Sacred Bloom is active |
...
| WORLD-06 | Garden Structures (Storage & Watchtower) | World & Map | Medium | Done | WORLD-05 | [Unassigned] | M | • Storage structure adds inventory slots per GDD §10.2 & §6.2; • Watchtower pre-rolls an exact next-night tactical forecast when built: active lanes, lane counts, enemy composition, boss warning, and minimap lane paths; • actual night wave consumes the same forecast plan; • both structures require material cost |
...
| DIFF-03 | Night 21 Surge Escalation | Core Mechanics | Medium | Not Started | ENEMY-01, DIFF-01, DIFF-02 | [Unassigned] | M | • Night 21 escalates through Surge Night pressure and late-game enemy composition, not a unique named boss; • story pressure comes from the Veld Devourer omen; • no story objective requires defeating a precursor before The Devourer |
...
| UI-05 | Pause Menu | UI/HUD | High | Done | FOUND-01 | [Unassigned] | S | • Accessible at any time (excluding hard-scripted cutscenes); • sub-screens: Settings, Save/Load, Main Menu per GDD §11.2; • game time frozen while paused |
...
| QUEST-02 | Daily Quests | Quest System | Medium | Done | QUEST-01 | [Unassigned] | M | • Daily objectives generated each Morning per GDD §16 (e.g., "Collect 10 Petal Shard", "Defeat 5 Shadowling"); • reward granted on completion; • quest expires at end of same day |
...
| QUEST-05 | Story Quests | Quest System | High | Done | QUEST-01, WORLD-02 | [Unassigned] | L | • Full chain per GDD §16: Meadow survival → Dusk Forest investigation → Blackwater road reveal → Ruins omen → Devourer; • critical quests carry time limits; • failure triggers alternative ending, not immediate game over per GDD §5.1 |
...
| AUDIO-03 | Night Defense Music (Dynamic Layer) | Audio/Visual | High | Done | FOUND-05 | [Unassigned] | M | • Dark synth-percussion track plays at Night per GDD §12.3; • high-intensity layer added automatically when >50% enemies alive; • layer crossfade is smooth in both directions |
| AUDIO-04 | Key SFX Implementation | Audio/Visual | Medium | Done | CORE-05, PLANT-05 | [Unassigned] | L | • All key SFX per GDD §12.3: crafting chime, plant activation, enemy hit, Core damage boom, Surge Night wind cue; • SFX volume balanced against music |
| VFX-01 | Player Animations | Audio/Visual | High | Done | FOUND-03 | [Unassigned] | L | • Attack, dash, and respawn animations per GDD §12.2; • states linked to player state machine; • respawn plays brief invincibility glow |
| VFX-02 | Dianthus Core Animations | Audio/Visual | High | Done | CORE-03 | [Unassigned] | M | • Idle glow, damage state, and destruction animations per GDD §12.2; • glow intensity tied to current HP value |
| VFX-03 | Enemy Animations | Audio/Visual | Medium | Done | CORE-06 | [Unassigned] | L | • Walk, attack, death, and retreat animations for all 6 enemy types per GDD §12.2; • death animation plays fully before entity removed |
| VFX-04 | Plant Animations | Audio/Visual | Medium | Done | PLANT-05 | [Unassigned] | M | • Shared PlantAnimationController and PlantBase hooks added; • all 11 plant entity scenes have scene-authored PlantAnimator nodes and SpriteFrames resources for bloom, active, and wither; • 64x64-derived bloom/active/wither sheets exist for every current plant sprite; • wither triggers through PlantBase destroy path |
...
| ACCESS-03 | Interactive Tutorial (Days 1–3) | Accessibility | High | In Progress | CORE-09 | [Unassigned] | L | • Tutorial guides player through movement, combat, crafting, and night defense across Days 1–3 per GDD §11.4; • fully skippable via Settings |
| ACCESS-04 | Text Speed Setting | Accessibility | Low | Done | UI-05, DIALOG-01 | [Unassigned] | XS | • Text speed slider (Slow / Normal / Fast / Instant) in Settings per GDD §11.4; • wired to Dialogic text-speed setting |
| DIALOG-01 | Dialogic Dialog System Integration | Quest System | High | Done | FOUND-01 | [Unassigned] | M | • Dialogic addon installed at `addons/dialogic/`; • author `.dch` character resources for named NPCs; • create `.dtl` timeline files for tutorial prompts + story quest cutscenes per GDD §16; • `Dialogic.start(timeline)` callable from QuestManager / NPC interact; • text-speed setting wired to Dialogic subsystem; • dialog pauses game world input while active |
| RES-01 | Resource Scarcity Scaling | Resource & Inventory | Medium | Done | DIFF-01 | [Unassigned] | M | • Common resources remain accessible throughout; Uncommon/Rare spawn rates decrease every 5 days per GDD §6.3; • Night reward (3–5 Common + 1 Uncommon per cleared wave) implemented |
